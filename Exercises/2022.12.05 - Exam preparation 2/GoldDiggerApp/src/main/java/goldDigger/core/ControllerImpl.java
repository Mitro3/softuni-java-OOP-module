...
public class ControllerImpl implements Controller {
    ...
    public String inspectSpot(String spotName) {
        ...
        int exhaustedDiscoverersCount = (int) suitableDiscoverers.stream()
                .filter(d -> d.getEnergy() == 0)
                .count();
        spotCount++;

        return String.format(INSPECT_SPOT, spotName, exhaustedDiscoverersCount);
    }
    ...
    public String getStatistics() {
        ...
        for (Discoverer discoverer : discoverers) {
            ...
            if (discovererExhibits.isEmpty()) {
                ...
                String allMuseumExhibitsText =
                        String.join(FINAL_DISCOVERER_MUSEUM_EXHIBITS_DELIMITER, discovererExhibits);
                sb.append(String.format(FINAL_DISCOVERER_MUSEUM_EXHIBITS, allMuseumExhibitsText))
